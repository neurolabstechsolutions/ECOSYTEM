...
async function testValidUuidInsert() {
  ...
  const toyotaId = 'a0000000-0000-4000-a000-000000000001';
  ...
  console.log('--- 4. Checking Final Inventory Count ---');
  const { data: finalItems } = await supabase.from('inventory_items').select('*');
  console.log('Final Items Count in Supabase:', finalItems?.length, finalItems);
}
